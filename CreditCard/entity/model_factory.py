...
MetricInfoArtifactreg = namedtuple("MetricInfoArtifactreg",
                                ["model_name", "model_object", "train_rmse", "test_rmse", "train_accuracy",
                                 "test_accuracy", "model_accuracy", "index_number"])

MetricInfoArtifact = namedtuple("MetricInfoArtifact",
                                ["model_name", "model_object", "train_log", "test_log", "train_accuracy",
                                 "test_accuracy", "model_accuracy", "index_number"])
        ...
        for model in model_list:
            ...
            if model_accuracy >= base_accuracy and diff_test_train_acc < 0.05:
                ...
                metric_info_artifact = MetricInfoArtifact(model_name=model_name,
                                                        model_object=model,
                                                        train_log=train_log_loss,
                                                        test_log=test_log_loss,
...
def evaluate_regression_model(model_list: list, X_train:np.ndarray, y_train:np.ndarray, X_test:np.ndarray, y_test:np.ndarray, base_accuracy:float=0.6) -> MetricInfoArtifactreg:
    """
    Description:
    This function compare multiple regression model return best model
    Params:
    ...
    MetricInfoArtifact = namedtuple("MetricInfo",
                                ["model_name", "model_object", "train_loss", "test_loss", "train_accuracy",
                                 "test_accuracy", "model_accuracy", "index_number"])
    """
    try:
        ...
        for model in model_list:
            ...
            if model_accuracy >= base_accuracy and diff_test_train_acc < 0.05:
                base_accuracy = model_accuracy
                metric_info_artifact = MetricInfoArtifactreg(model_name=model_name,
                                                        model_object=model,
